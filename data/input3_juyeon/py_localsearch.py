...
# 입력 및 데이터베이스 경로 정의
INPUT_DIR = "/Users/jiyoon/Library/Mobile Documents/com~apple~CloudDocs/황금토끼 GraphRAG/2025 캡스톤 프로젝트/domain_qa_system/data/input3_juyeon/output"
query = "모바일소프트웨어트랙의 사람을 모두 알려주세요."
